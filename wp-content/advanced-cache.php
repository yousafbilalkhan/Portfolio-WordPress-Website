...
$possible_plugin_locations = array(
	...
	'C:\xampp\htdocs\Portfolio\wp-content\plugins\wp-optimize\cache',
);
...
if (false === $plugin_location) {
	...
	if (strcasecmp('http://localhost/Portfolio/', $protocol . '://' . $host . $request_uri) === 0) {
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', 'C:\xampp\htdocs\Portfolio\wp-content\plugins\wp-optimize\cache/extensions');
}
